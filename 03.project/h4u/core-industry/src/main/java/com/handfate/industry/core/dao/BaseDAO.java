...
public class BaseDAO {
    ...
    public List<Map> getContractInfo(int contract_id) throws Exception {
        String cql = "select c.*,r.NAME room_name, r.STAGE , h.name as house_name, h.ADDRESS house_address,\n"
                + "pc.original_address, pc.supply_address, pc.people_id, pc.mobile, pc.mobile_1,"
