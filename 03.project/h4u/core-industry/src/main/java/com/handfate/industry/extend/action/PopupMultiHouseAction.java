 ...
 * @author HienDM1
 */
public class PopupMultiHouseAction extends PopupMultiAction  {

    /**
     * ANHPTN
     */
    public PopupMultiHouseAction(UI localMainUI) throws Exception {
        ...
        addTextFieldToForm("Giá điện", new TextField(), "electric_price", "int", true, 18, null, null, true, false, null, false, null, true, true, true, true, null);
        addTextFieldToForm("Giá nước", new TextField(), "water_price", "int", true, 18, null, null, true, false, null, false, null, true, true, true, true, null);
        addTextFieldToForm("Giá máy giặt", new TextField(), "washing_price", "int", true, 18, null, null, true, false, null, false, null, true, true, true, true, null);
        addTextFieldToForm("Giá vệ sinh", new TextField(), "clean_price", "int", true, 18, null, null, true, false, null, false, null, true, true, true, true, null);
        addTextFieldToForm("Giá truyền hình", new TextField(), "television_price", "int", true, 18, null, null, true, false, null, false, null, true, true, true, true, null);
        addTextFieldToForm("Giá internet", new TextField(), "internet_price", "int", true, 18, null, null, true, false, null, false, null, true, true, true, true, null);
