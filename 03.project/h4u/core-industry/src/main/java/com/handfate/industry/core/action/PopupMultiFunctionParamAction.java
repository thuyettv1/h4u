...
public class PopupMultiFunctionParamAction extends PopupMultiAction {
     ...
     */ 
    public PopupMultiFunctionParamAction(UI localMainUI) throws Exception {
        //Khởi tạo tham số
        setTableName("sd_func_param");
        setIdColumnName("id");
        setNameColumn("value");
        setPageLength(10);
        ...
        setSequenceName("sd_func_param_seq");
