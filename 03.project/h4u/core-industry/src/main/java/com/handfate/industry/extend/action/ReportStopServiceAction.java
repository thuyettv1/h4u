 ...
 * @author HienDM1
 */
public class ReportStopServiceAction extends BaseAction {
    ...
    public HorizontalLayout init(UI localMainUI) throws Exception {
        ...
        setAllowEdit(false);
        setAllowExport(true);
        setTemplateFile("Report_Customer_Stop_Service.xls");
        setTemplateHeight(9);
      ...
      //  addComponentToForm("Transaction.AccountCreater", new TextField(), "code", "string", true, 100, null, null, true, false);             
        ...
        addTextFieldToForm("Report.amountAccountStop", new TextField(), "AMOUNT_OF_ACCOUNT", "int", false, null, null, null, false, false, null, false, null, true, true, true, true, null);
        ...
        addTextFieldToForm("Report.StopDate", new PopupDateField(), "CHANGE_DATE_HIS", "date", true, null, null, null, true, false, "date:and_mandatory:366", false, lstParam, true, true, true, true, null);
        addTextFieldToForm("Report.causeStop", new TextField(), "CAUSE_CHANGE_HIS", "string", false, null, null, null, false, false, null, false, null, true, true, true, true, null);        
