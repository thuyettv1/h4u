 ...
 *
 * Download jquery and highcharts.js (if not already loaded in your webapp) and
 * save them in the resource directory org/vaadin/highcharts. Create a new class
 * in the package org.vaadin.highcharts (e.g. "HighChart") and inherit it from
 * AbstractHighChart. Then add a proper JavaScript annotation to the newly
 * created class in order to load all necessary JavaScript libraries that you
 * need (e.g. jquery.js, highcharts.js, highcharts-more.js, ...). Make sure your
 * project complies with the licenses of those libraries. At the end of this
 * list add "highcharts-connector.js".
 *
 * <p>
 * Example of how to extend <code>AbstractHighChart</code>:</p>
 * <pre>
...
public abstract class AbstractHighChart extends AbstractJavaScriptComponent {
    ...
    public int chartId = nextChartId();
    ...
    /**
     * Sets the Highcharts JavaScript code describing the chart. Note that this
     * code needs to bind the the JSON definition of the chart to a JS variable
