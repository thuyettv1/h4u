...
public class GroupAction extends BaseAction {
    ...
    public HorizontalLayout init(UI localMainUI) throws Exception {
        ...
        addTextFieldToForm("Group.GroupName", new TextField(), "group_name", "string", true, 50, null, null, true, false, null, false, null, true, true, true, true, null);
        addTextFieldToForm("Group.GroupCode", new TextField(), "group_code", "string", true, 100, null, null, true, false, null, false, null, true, true, true, true, null);
